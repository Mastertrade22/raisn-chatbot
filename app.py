...
def router_node(state: AgentState) -> dict:
    ...
    """
    print(f"[{state['model_name']}] 🧭 Router analyzing question...")
...
def sql_gen_node(state: AgentState) -> dict:
    ...
    """
    print(f"[{state['model_name']}] 🔧 Generating SQL query...")
...
SQL query:"""
        ...
        print(f"[{state['model_name']}] 📝 Generated SQL: {sql_query}")
...
def execute_sql_node(state: AgentState) -> dict:
    ...
    try:
        ...
        print(f"[{state['model_name']}] ✅ Query successful: {len(results)} rows")
...
def response_node(state: AgentState) -> dict:
    ...
    """
    print(f"[{state['model_name']}] 💬 Generating final response...")
...
Provide a clear, concise answer:"""
        ...
        print(f"[{state['model_name']}] ❌ Response generation error: {str(e)}")
...
def compare_models(question: str, chat_history: List[dict] = None):
    ...
    for model_display_name, model_id in models.items():
        ...
        try:
            ...
            print(f"\n✨ {model_display_name} Response:")
            print(f"{final_state['final_answer']}\n")

        except Exception as e:
            error_msg = str(e)
            print(f"\n❌ {model_display_name} Error: {error_msg}\n")
...
if __name__ == "__main__":
    # Setup database
    print("🏗️  Setting up Real Estate database...")
